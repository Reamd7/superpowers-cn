...
The headline change is **skills repository separation**: all skills, scripts, and documentation have moved from the plugin into a dedicated repository ([reamd7/superpowers-cn-skills](https://github.com/reamd7/superpowers-cn-skills)). This transforms superpowers from a monolithic plugin into a lightweight shim that manages a local clone of the skills repository. Skills auto-update on session start. Users fork and contribute improvements via standard git workflows. The skills library versions independently from the plugin.
...
**The biggest change:** Skills no longer live in the plugin. They've been moved to a separate repository at [reamd7/superpowers-cn-skills](https://github.com/reamd7/superpowers-cn-skills).
...
3. Fresh clone of reamd7/superpowers-cn-skills will be created at `~/.config/superpowers/skills/`
...
- Clones reamd7/superpowers-cn-skills on first run
...
**Removed:**
- `skills/` directory (82 files) - Now in reamd7/superpowers-cn-skills
- `scripts/` directory - Now in reamd7/superpowers-cn-skills/skills/using-skills/
...
```bash
# In Claude Code
/plugin marketplace add reamd7/superpowers-cn-marketplace
...
- Skills repository is now at https://github.com/reamd7/superpowers-cn-skills
...
**Full Changelog:** https://github.com/reamd7/superpowers-cn/compare/dd013f6...main
**Skills Repository:** https://github.com/reamd7/superpowers-cn-skills
**Issues:** https://github.com/reamd7/superpowers-cn/issues
